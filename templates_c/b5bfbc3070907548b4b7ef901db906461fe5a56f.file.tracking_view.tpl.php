<?php /* Smarty version Smarty-3.1.12, created on 2013-10-06 19:50:38
         compiled from "/home/shipon/public_html/new_bol/_pro-minimax/templates/tracking/tracking_view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:171626679051ec922499ee98-87956465%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b5bfbc3070907548b4b7ef901db906461fe5a56f' => 
    array (
      0 => '/home/shipon/public_html/new_bol/_pro-minimax/templates/tracking/tracking_view.tpl',
      1 => 1381103431,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '171626679051ec922499ee98-87956465',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.12',
  'unifunc' => 'content_51ec9224d83023_81213794',
  'variables' => 
  array (
    'lang' => 0,
    'request' => 0,
...
<?php if ($_valid && !is_callable('content_51ec9224d83023_81213794')) {function content_51ec9224d83023_81213794($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/home/shipon/public_html/new_bol/_CORE/includes/smarty/libs/plugins/modifier.replace.php';
...
">POD</a>&nbsp;&nbsp;<?php }?>
				<?php } ?>
                        ...
                        <?php if (isset($_smarty_tpl->tpl_vars['data']->value['doc'])){?>
                                <?php  $_smarty_tpl->tpl_vars['doc'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['doc']->_loop = false;
 $_smarty_tpl->tpl_vars['i'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['data']->value['doc']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['doc']->key => $_smarty_tpl->tpl_vars['doc']->value){
$_smarty_tpl->tpl_vars['doc']->_loop = true;
 $_smarty_tpl->tpl_vars['i']->value = $_smarty_tpl->tpl_vars['doc']->key;
?>
                                        <?php if ($_smarty_tpl->tpl_vars['doc']->value!=''){?><a href="<?php echo $_smarty_tpl->tpl_vars['doc']->value;?>
">DOC</a>&nbsp;&nbsp;<?php }?>
                                <?php } ?>
                        <?php }?>
			</div>
				...
				<tbody>
					<tr>
						...
						<td class='value'><?php echo $_smarty_tpl->tpl_vars['data']->value['RecStatus'];?>
                                        ...
                                        <?php if ((count($_smarty_tpl->tpl_vars['data']->value['PupDate'])>0&&$_smarty_tpl->tpl_vars['data']->value['PupDate']!='')||(count($_smarty_tpl->tpl_vars['data']->value['DelDate'])>0&&$_smarty_tpl->tpl_vars['data']->value['DelTime']!='')){?>
                                        <tr>
                                                <td class='label'>Pickup Date</td>
                                                <td class='value'><?php if (count($_smarty_tpl->tpl_vars['data']->value['PupDate'])>0){?><?php echo $_smarty_tpl->tpl_vars['data']->value['PupDate'];?>
<?php }else{ ?> - <?php }?></td>
                                                <td class='space'>&nbsp;</td>
                                                <td class='label'>Delivery Date</td>
                                                <td class='value'><?php if (count($_smarty_tpl->tpl_vars['data']->value['DelDate'])>0){?><?php echo $_smarty_tpl->tpl_vars['data']->value['DelDate'];?>
<?php }else{ ?> - <?php }?></td>
                                        </tr>
                                        <?php }?>
